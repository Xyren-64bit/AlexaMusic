...
from XyrenMusic.utils import Alexabin, get_channeplayCB, seconds_to_min
from XyrenMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from XyrenMusic.utils.decorators.language import language, languageCB
from XyrenMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://i.ibb.co/TDkY6Cgt/photo-2025-05-30-20-32-00.jpg//file/6f7d35131f69951c74ee5.jpg",
        caption=_["queue_1"],
    )
